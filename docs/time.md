...
To change the default timezone to covert time instances to you can use [`goqu.SetTimeLocation`](https://godoc.org/github.com/kovetskiy/goqu#SetTimeLocation) to change the default timezone.
