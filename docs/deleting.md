...
<a name="create"></a>
To create a [`DeleteDataset`](https://godoc.org/github.com/kovetskiy/goqu/#DeleteDataset)  you can use

**[`goqu.Delete`](https://godoc.org/github.com/kovetskiy/goqu/#Delete)**
...
**[`SelectDataset.Delete`](https://godoc.org/github.com/kovetskiy/goqu/#SelectDataset.Delete)**
...
**[`DialectWrapper.Delete`](https://godoc.org/github.com/kovetskiy/goqu/#DialectWrapper.Delete)**
...
**[`Database.Delete`](https://godoc.org/github.com/kovetskiy/goqu/#DialectWrapper.Delete)**
...
For more examples visit the **[Docs](https://godoc.org/github.com/kovetskiy/goqu/#DeleteDataset)**
...
<a name="prepared"></a>
**[`Prepared`](https://godoc.org/github.com/kovetskiy/goqu/#DeleteDataset.Prepared)**
...
<a name="where"></a>
**[`Where`](https://godoc.org/github.com/kovetskiy/goqu/#DeleteDataset.Where)**
...
<a name="order"></a>
**[`Order`](https://godoc.org/github.com/kovetskiy/goqu/#DeleteDataset.Order)**
...
<a name="limit"></a>
**[`Limit`](https://godoc.org/github.com/kovetskiy/goqu/#DeleteDataset.Limit)**
...
<a name="returning"></a>
**[`Returning`](https://godoc.org/github.com/kovetskiy/goqu/#DeleteDataset.Returning)**
...
<a name="seterror"></a>
**[`SetError`](https://godoc.org/github.com/kovetskiy/goqu/#DeleteDataset.SetError)**
...
To execute DELETES use [`Database.Delete`](https://godoc.org/github.com/kovetskiy/goqu/#Database.Delete) to create your dataset
