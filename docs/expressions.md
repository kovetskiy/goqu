...
You can also use the [`Op`](https://godoc.org/github.com/kovetskiy/goqu#Op) map which allows you to create more complex expressions using the map syntax. When using the `Op` map the key is the name of the comparison you want to make (e.g. `"neq"`, `"like"`, `"is"`, `"in"`), the key is case insensitive.
...
```
For a more complete examples see the [`Op`](https://godoc.org/github.com/kovetskiy/goqu#Op) and [`Ex`](https://godoc.org/github.com/kovetskiy/goqu#Ex) docs
...
```
For a more complete examples see the [`Op`](https://godoc.org/github.com/kovetskiy/goqu#Op) and [`ExOr`](https://godoc.org/github.com/kovetskiy/goqu#Ex) docs

<a name="S"></a>
**[`S()`](https://godoc.org/github.com/kovetskiy/goqu#S)**
...
<a name="T"></a>
**[`T()`](https://godoc.org/github.com/kovetskiy/goqu#T)** 
...
<a name="C"></a>
**[`C()`](https://godoc.org/github.com/kovetskiy/goqu#C)** 

An Identifier that represents a Column. See the [docs]((https://godoc.org/github.com/kovetskiy/goqu#C)) for more examples
...
<a name="I"></a>
**[`I()`](https://godoc.org/github.com/kovetskiy/goqu#I)** 
...
<a name="L"></a>
**[`L()`](https://godoc.org/github.com/kovetskiy/goqu#L)** 
...
<a name="V"></a>
**[`V()`](https://godoc.org/github.com/kovetskiy/goqu#V)**
...
<a name="and"></a>
**[`And()`](https://godoc.org/github.com/kovetskiy/goqu#And)** 
...
<a name="or"></a>
**[`Or()`](https://godoc.org/github.com/kovetskiy/goqu#Or)** 
